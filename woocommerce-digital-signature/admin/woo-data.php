...
class esigWooData {
	...
	public function enqueue_admin_scripts() {
		...
		$admin_screens = array(
			...
			'shop_order',
			'woocommerce_page_wc-orders', // HPOS order edit screen.
		...
		if ( in_array( esig_woocommerce_get( 'id', $screen ), $admin_screens ) ) {
			...
			wp_enqueue_script( 'esig-woocommerce-admin-script', plugins_url( 'assets/js/esig-commerce.js', __FILE__ ), array( 'jquery', 'jquery-ui-dialog' ), filemtime( plugin_dir_path( __FILE__ ) . 'assets/js/esig-commerce.js' ), true );

			wp_localize_script(
				'esig-woocommerce-admin-script',
				'esig_woo_params',
				array(
